# 🗓️ 2026-02-19  
# 线性代数：向量三重积 (Vector Triple Product)

> Generated for Ludan's Linear Algebra Self-Study  
> 目标方向：为计量经济 / HEOR 打基础的三维向量结构理解

---

## 🎯 学习目标

- 掌握向量三重积的展开公式（**BAC-CAB 法则**）
- 理解其“从三维回到二维”的几何本质
- 理解其在投影、变量拆解中的应用逻辑
...
- 结果是一个 **向量**
- 结果是 **b 和 c 的线性组合**
- 结果一定落在 span{b, c} 所张成的平面内

---

# 2️⃣ 几何直觉：三维 → 二维的“降维”

向量三重积在几何上完成了一次“飞出去再落回地面”的过程。
...
— Ludan Linear Algebra Self-Study  
— Preparing for Quantitative Economics  
— 2026
