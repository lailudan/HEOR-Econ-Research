...
Lec1: https://youtu.be/eIb1cz06UwI?si=skOklIpD5-slxze6


<img width="1282" height="2312" alt="10a22e4ac11ced012e40466e3bd61172" src="https://github.com/user-attachments/assets/c7f7c3e1-9550-4b2a-962a-06b2374efa5b" />


### 🌓 欧拉 vs. 哈密顿：路径的两种哲学 （拓展问题）

**1. 欧拉路径 (Eulerian) - “边的秩序”**
- 关注：轨迹的完整性。走遍每一条边 (Edge)，每条边只能走一次，点可以重复。
- 关键：度数的奇偶性。
- 心得：这是“连通性”的底层保障。

**2. 哈密顿路径 (Hamiltonian) - “点的效率”**
- 关注：目标的唯一性。访问每一个顶点 (Vertex)，每个点只能访问一次，边可以舍弃。
- 关键：全局结构的微妙平衡。
