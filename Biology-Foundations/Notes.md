...
## 1. 细胞基础与分类 (Cell Foundations)
| 单词 | 音标 | 定义 | HEOR/科研关联 |
| :--- | :--- | :--- | :--- |
| **Prokaryote** | /proʊˈkærioʊt/ | 原核生物 | 主要是细菌。在流调中用于区分细菌性与病毒性感染。 |
| **Eukaryote** | /juːˈkærioʊt/ | 真核细胞 | 人类细胞（包括神经元）。其复杂性决定了药物研发的高成本。 |
| **Plasma Membrane** | /ˈplæzmə/ | 细胞膜 | 药物进入细胞的第一道屏障，涉及“药物转运体”研究。 |
| **Cytoplasm** | /ˈsaɪtoʊplæzəm/ | 细胞质 | 蛋白聚集（如 Lewy Bodies）发生的场所。 |
| **Organelle** | /ˌɔːrɡəˈnɛl/ | 细胞器 | 细胞内的“器官”，功能故障常导致慢性退行性疾病。 |

## 2. 蛋白质生产与垃圾处理 (Protein & Waste - YOPD/YOAD 核心)
| 单词 | 音标 | 定义 | HEOR/科研关联 |
| :--- | :--- | :--- | :--- |
| **Ribosome** | /ˈraɪbəsoʊm/ | 核糖体 | **蛋白质工厂**。YOAD 中残次蛋白（Tau）的源头。 |
| **Endoplasmic Reticulum (ER)** | /ˌɛndəˌplæzmɪk/ | 内质网 | 蛋白折叠处。**ER Stress（内质网应激）**是神经退行性病的机制。 |
| **Golgi Complex** | /ˈɡoʊldʒi/ | 高尔基体 | 分拣中心。涉及神经递质（多巴胺）的包装与转运。 |
| **Lysosome** | /ˈlaɪsəsoʊm/ | 溶酶体 | **垃圾处理站**。其功能失效导致 YOPD 蛋白堆积。 |
| **Autophagy** | /ɔːˈtɒfədʒi/ | 自噬作用 | 细胞自我清理机制。HEOR 关注针对自噬的新药性价比。 |

## 3. 能量与信号传导 (Energy & Signaling)
| 单词 | 音标 | 定义 | HEOR/科研关联 |
| :--- | :--- | :--- | :--- |
| **Mitochondria** | /ˌmaɪtəˈkɒndriə/ | 线粒体 | **能量工厂**。YOPD 研究中线粒体损伤导致神经元死亡。 |
| **ATP (Adenosine Triphosphate)** | /ˌeɪ tiː ˈpiː/ | 能量货币 | 主动运输的代价。HEOR 模型中维持稳态的生物成本。 |
| **Receptor** | /rɪˈsɛptər/ | 受体 | 药物结合的“锁”。决定了靶向药的入组标准（精准医疗）。 |
| **Ligand** | /ˈlaɪɡənd/ | 配体 | 结合受体的分子（如药物、神经递质）。 |
| **Apoptosis** | /ˌæpəpˈtoʊsɪs/ | 细胞凋亡 | 细胞程序性死亡。治疗 YOPD 的终极目标是延缓凋亡。 |

## 4. 物质运输 (Cell Transport)
| 单词 | 音标 | 定义 | HEOR/科研关联 |
| :--- | :--- | :--- | :--- |
| **Passive Transport** | /ˈpæsɪv/ | 被动运输 | 顺浓度梯度，不耗能。 |
| **Active Transport** | /ˈæktɪv/ | 主动运输 | 耗能运输。药物耐药性常因细胞主动把药“泵”出去。 |
| **Endocytosis** | /ˌɛndoʊsaɪˈtoʊsɪs/ | 胞吞作用 | 病毒进入细胞、神经元吸收大分子蛋白的方式。 |
| **Exocytosis** | /ˌɛksoʊsaɪˈtoʊsɪs/ | 胞吐作用 | **多巴胺释放**的物理机制。 |

## 5. 常见词根 (Suffixes & Prefixes)
* **Cyto-**: 细胞 (e.g., Cytoskeleton)
* **-ase**: 酶 (e.g., Polymerase - 药物研发中常见的抑制靶点)
* **-osis**: 状态/过程 (e.g., Endocytosis)
* **Hyper-**: 高 (e.g., Hypertonic 高渗)
